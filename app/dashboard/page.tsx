...
import { PlusCircle, ArrowRight, Pencil, Heart, Lightbulb } from "lucide-react";
...
async function CreatorDashboard({ userId, displayName, email }: { userId: string; displayName: string; email: string }) {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Feature request CTA */}
      <a
        href="mailto:hello@getthatbread.sg?subject=Feature%20request&body=Hi%20team%2C%0A%0AHere%27s%20an%20idea%20I%20think%20would%20make%20get%20that%20bread%20better%3A%0A%0A%0A%0AThanks%21"
