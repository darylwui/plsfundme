...
export function Footer() {
  return (
    <footer className="border-t border-[#4A2E1A] bg-[#2C1A0E]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-10 pt-6 border-t border-[#4A2E1A] flex flex-col sm:flex-row items-center justify-between gap-2">
