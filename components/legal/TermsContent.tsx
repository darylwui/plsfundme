      ...
      <div className="prose prose-sm max-w-none text-[var(--color-ink)] prose-headings:text-[var(--color-ink)] prose-headings:font-black prose-a:text-[var(--color-brand-crust)] space-y-8">
        ...
        <Section title="5. Milestone-Based Escrow Funding Model">
          ...
          <p>
            ...
            <a href="/terms?tab=refund">Refund &amp; Dispute Policy</a>, which is incorporated into these Terms by reference.
          </p>
        </Section>
        ...
        <Section title="11. Privacy">
          <p>
            ...
            <a href="/terms?tab=privacy">Privacy Policy</a>, which is incorporated into these Terms by reference. By
