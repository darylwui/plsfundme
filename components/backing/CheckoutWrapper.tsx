...
export function CheckoutWrapper({
  ...
  // Captured in Phase 1 so they're included in the intent creation request
  ...
  if (!payMethod || (!data && !loading)) {
    return (
      <div className="flex flex-col gap-5">
        ...
        {/* Options — captured before intent creation so values are persisted */}
